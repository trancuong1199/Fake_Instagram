...
function Main() {
    ...
    const ListReels = ({name, image}) => (
        <View style={styles.accountPost}>
            <Image style={styles.story} source={{ uri: image }} />
            <Text style={styles.nameAccount}>{name}</Text>
        </View>
    )
    
    const ListBlogs = ({name, image, blog}) => (
        <View style={styles.newsMain}>
            <View style={styles.newsMainTop}>
                <View style={styles.newsMainTopRight}>
                    <Image style={styles.avatar} source={{ uri: image }} />
                    <Text style={styles.newsMainName}>{name}</Text>
                </View>
                <Text style={styles.more}>...</Text>
            </View>
            <Image style={styles.newsMainPost} source={{uri: blog}} />
            ...
            <View style={styles.layout}>
                ...
                <View style={styles.newPost}>
                    <FlatList
                        ...
                        data={accounts}
                        renderItem={({item}) => <ListReels name={item.name} image={item.image}/>}
